...
Like the base game, the Creation Kit comes with a set of two INI files: **CreationKit.ini** and **CreationKitPrefs.ini**. They can be modified directly or overwritten by a **CreationKitCustom.ini**. We will go with the latter option and grab a preconfigured custom INI from the Nexus.
